...
import com.example.HostHub.Security.AuthService;
import com.example.HostHub.dto.LoginDto;
import com.example.HostHub.dto.LoginResponseDto;
...
public class AuthController {
    ...
    public ResponseEntity<LoginResponseDto>refresh(HttpServletRequest request){
        ...
        String refreshToken= Arrays.stream(request.getCookies())
                ...
                .findFirst()
                .map(Cookie::getValue)
                .orElseThrow(()->new AuthenticationServiceException("Refresh token not found with this Cookies"));
